...
class GradebookControllerTest {
    ...
    void createStudentHttpRequest() throws Exception {
        ...
        List<CollegeStudent> studentsList = List.of(studentOne);
    ...
    @Test
    void deleteNonExistentStudentHttpRequest() throws Exception {
        MvcResult mvcResult = mockMvc.perform(
    ...
    @Test
    void studentInformationNonExistentStudentHttpRequest() throws Exception {
    ...
    @Test
    void deleteGradeForNonExistentStudent() throws Exception {
        MvcResult mvcResult = mockMvc.perform(
